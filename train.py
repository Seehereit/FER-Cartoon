...
def run(net, logger, hps):
    # Create dataloaders
    trainloader, valloader, testloader = get_dataloaders(path='datasets/fer2013/fer2013_cartoonized.csv', bs=hps['bs'])
    ...
    elif hps['sche'] == 'CosineAnnealingLR':
